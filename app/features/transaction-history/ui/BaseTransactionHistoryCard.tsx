            ...
            <BaseTable ui="dashkit" variant="card" nowrap>
                <BaseTable.Head>
                    <BaseTable.Row>
                        ...
                        <BaseTable.HeaderCell className="text-dk-gray-700">Memo</BaseTable.HeaderCell>
...
function TransactionRow({
    row: { signature, slot, blockTime, status, instructionsCell, memoCell, rawDataCell },
    hasTimestamps,
}: {
    ...
    return (
        <BaseTable.Row>
            ...
            <BaseTable.Cell>{memoCell}</BaseTable.Cell>
